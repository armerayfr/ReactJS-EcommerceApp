...
class Cart extends React.Component {
      ...
      return (
        <tr>
          ...
          <td className="align-middle">
            <img src={val.productImage} style={{ height: "125px" }} alt="" />
          </td>
  ...
  payBtnHandler = () => {
    ...
    //2. DELETE semua item yang sudah dibayar
    const d = new Date();
    Axios.post(`${API_URL}/transactions`, {
      ...
      transactionItems: this.props.cartGlobal.cartList, //array of object => product kita ( cart )
    })
      .then((result) => {
            ...
            <div className="col-3">
              ...
              <div className="card text-left">
                ...
                <div className="card-body">
                  <div className="d-flex mt-2 flex-row justify-content-between align-items-center">
                    <span
                ...
                <div className="card-body border-top">
                  <label htmlFor="recipientName">Recepient Name</label>
                  <input
